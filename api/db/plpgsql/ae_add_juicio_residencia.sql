DROP FUNCTION IF EXISTS ae_add_juicio_residencia(id_document numeric, applicant json[], defendant json[], witness json[], notary json[], diligence text, charges json[], appeals json[]);

CREATE OR REPLACE FUNCTION ae_add_juicio_residencia(
  id_document numeric,
  applicant json[],
  defendant json[],
  witness json[],
